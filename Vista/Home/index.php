...
<div id="indexElement">  
  ...
  <div class="row align-items-center border-top justify-content-center">
    <div class="col-10 text-center pt-3">
      <h3>Metodos utilizados para generar zip</h3>
    </div>
  </div>
  <div class="row align-items-center justify-content-center">
    <div class="col-10 col-md-6 col-lg-5">
    <a href='https://www.php.net/manual/es/ziparchive.open' class='cascadia-code'>ZipArchive::open($nombreZip)</a><br>
    <a href='https://www.php.net/manual/es/ziparchive.addfile' class='cascadia-code'>ZipArchive::addFile($rutaFichero)</a><br>
    <a href='https://www.php.net/manual/es/ziparchive.close' class='cascadia-code'>ZipArchive::close()</a><br>
    <img class="img-fluid" src="../Imagenes/generarComprimido.png">
    </div>
    <div class="col-10 col-md-6 col-lg-5">
    <a href='https://nullpoint3r.wordpress.com/2011/06/05/pclzip-trabajando-con-ficheros-comprimidos-en-php/' class='cascadia-code'>PclZip::add($rutaFichero)</a><br>
    <img class="img-fluid" src="../Imagenes/comprimidoPclzip.png">
    </div>
  </div>
  ...
  <div class="row align-items-center  border-top justify-content-center mt-3 ">
    <div class="col-10 text-center pt-3 ">
      <h3>Metodos utilizados descomprimir zip</h3>
    </div>
    ...
    <a href='https://www.php.net/manual/en/ziparchive.extractto.php'>ZipArchive::extractTo($ruta)</a><br>
    <a href='https://www.php.net/manual/es/ziparchive.close' class='cascadia-code'>ZipArchive::close()</a><br>
    <img class="img-fluid" src="../Imagenes/descomprimirzip.png">
    </div>
    
    <div class="col-10 col-md-6 col-lg-5">
    <a href='https://wp-kama.com/function/PclZip::extract' class='cascadia-code'>PclZip::extract($ruta)</a><br>
    <img class="img-fluid" src="../Imagenes/descomprimirpclzip.png">
    </div>
    ...
    <div class="row align-items-center border-top justify-content-center mt-3">
      ...
      <div class="row align-items-center justify-content-center">
        <div class="">
          ...
          <p>3. Incluir el archivo en los archivos de control de comprimir y descomprimir con<b>include_once('[ruta]/pclzip.lib.php')</b></p> 
